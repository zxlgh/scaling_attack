...
if __name__ == '__main__':
    ...
    path = r'/home/scaling_attack/image/diff-target/448'
    ...
    im.save(os.path.join(path, 'scale_64.png'))
    im = Image.fromarray(res_2)
    im.save(os.path.join(path, 'scale_96.png'))
    im = Image.fromarray(res_3)
    im.save(os.path.join(path, 'scale_114.png'))

    path = r'/home/scaling_attack/image/diff-target/1024'
    if not os.path.exists(path):
        os.makedirs(path)
